                        ...
                        <form action="{{route('updateExpense', $expense->id)}}" method="POST">
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                    ...
                                    <div class="grid gap-6">
                                        <div class="col-span-3 sm:col-span-3">
                                            <label for="first-name" class="block text-sm font-medium text-gray-700">Date
                                                Entry</label>
                                            <input type="date" name="entry_date" value="{{$expense->entry_date}}"
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <select name="expense_category_id" id="company-size"
                                                        ...
                                                        $expense_category)
                                                        <option value="{{ $id }}">{{ $expense_category }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <a href="{{route('createExpense')}}">Click Here</a>
                                    </div>
                                </div>
                                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                    ...
                                    <button type="submit"
                                        class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-400 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>

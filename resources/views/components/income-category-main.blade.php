    ...
    <div class="justify-center">
        <table class="w-full  border border-slate-400 table-auto">
            <thead class="bg-gray-50 border-b-2 border-gray-200">
                <th>
                    <h1 class="text-2xl p-4">Income Category</h1>
                </th>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-3 text-sm text-gray-700">
                        <a href="{{route('editIncomeCategory', $category->id)}}" class="bg-yellow-200 
                        text-yellow-800 p-2 
                        text-center
                        text-sm
                        rounded-full
                ...
                @empty
                <h1 class="p-3 text-2xl text-red-700">No Income Categories Yet</h1>
                @endforelse
